...
class LibraryManagement:
    ...
    def remove_book(self):
        if self.current_user in self.admins:
            ...
            self.frames['remove_book'] = self.current_frame
            ...
            self.submit_button = tk.Button(self.current_frame, text="Submit", command=self.submit_remove_book, font=("Helvetica", 12))
            self.submit_button.pack(pady=5)
        else:
    ...
    def issue_book(self):
        if self.current_user in self.students:
            ...
            self.frames['issue_book'] = self.current_frame
            ...
            self.submit_button = tk.Button(self.current_frame, text="Submit", command=self.submit_issue_book, font=("Helvetica", 12))
            self.submit_button.pack(pady=5)
        else:
    ...
    def return_book(self):
        if self.current_user in self.students:
            ...
            self.frames['return_book'] = self.current_frame
            ...
            self.submit_button = tk.Button(self.current_frame, text="Submit", command=self.submit_return_book, font=("Helvetica", 12))
            self.submit_button.pack(pady=5)
        else:
